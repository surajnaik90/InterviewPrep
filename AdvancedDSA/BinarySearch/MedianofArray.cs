...
public static class MedianofArray
{
    public static double solve(List<int> A, List<int> B)
    {
        double result = 0;

        int m = A.Count, n = B.Count, p1 = 0, p2 = 0, p3 = 0;
        int[] c = new int[m + n];
        ...
        if (c.Length % 2 != 0) {
            ...
            result = (((double)c[mid] + (double)c[mid - 1]) / 2);
        }
