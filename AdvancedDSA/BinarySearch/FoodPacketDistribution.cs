...
and people can go to an office of their own city. We want to maximize the minimum number of people
...
*/
public static class FoodPacketDistribution
{
    public static int solve(List<int> A, int B)
    {
        ...
        double left = 1, right = sum; double mid = 0, res = double.MaxValue;
