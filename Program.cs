...
////int res = IsDictionary.solve(new List<string>() { "ipial", "qjqgt", "vfnue", "vjqfp", "eghva", "ufaeo", "atyqz", "chmxy", "ccvgv", "ghtow" }, "nbpfhmirzqxsjwdoveuacykltg");
...
////int res = MinimumSwaps.solve(new List<int>() { 12,25, 18, 19, 88, 87, 65, 66, 1 ,2, 3, 7, 112, 25, 26, 27, 28, 95, 5, 4 }, 7);

////int res = MinimumSwaps.solve(new List<int>() { 45, 40, 48, 23, 21, 55, 9, 15, 87, 65, 73, 57, 94, 94, 59, 67, 73, 93, 11, 18, 45, 44, 65, 97, 63, 74, 17, 80, 85, 18, 54, 2, 1, 95, 48, 74, 74, 67, 93, 70, 37, 89, 8, 4, 86, 87, 15, 59, 49, 55, 61, 90, 38, 40, 20, 3, 45, 33, 99, 45, 56, 77, 51, 73, 30, 28, 59, 41, 1, 61, 69, 62, 63, 80, 24, 18, 70, 4, 36, 47, 44, 35, 46, 37, 32, 75, 98, 54 }, 3);

////int res = MinimumSwaps.solve2(new List<int>() { 52, 7, 93, 47, 68, 26, 51, 44, 5, 41, 88, 19, 78, 38, 17, 13, 24, 74, 92, 5, 84, 27, 48, 49, 37, 59, 3, 56, 79, 26, 55, 60, 16, 83, 63, 40, 55, 9, 96, 29, 7, 22, 27, 74, 78, 38, 11, 65, 29, 52, 36, 21, 94, 46, 52, 47, 87, 33, 87, 70 }, 19);
...
////int res = LargestCoprimeDivisor.solve(30, 12);

////int res = FirstMissingInteger.solve(new List<int>() { -8,-7,-6});

////int res = PrimeModuloInverse.solve2(6, 23);
...
////List<int> res = NextGreater.solve(new List<int>() { 34, 35, 27, 42, 5, 28, 39, 20, 28 });
